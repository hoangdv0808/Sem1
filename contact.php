...
<body>
  ...
  <div id="loading"></div>
  <div class="ready banner-padding bg-img bg-fixed valign" style="background-image: url(images/slider/3.jpg);">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
  ...
  <div class="section-padding">
    <div class="container">
      <div class="row">
        <div class="col-md-12"><span>Informations</span>
        ...
        <div class="col-md-12">
          <div class="row mb-60">
            ...
            <div class="col-md-4 mb-30">
              <p>Getting married or interested in getting glam? Find out whether I&apos;m available,
                enquire today!</p>
              ...
              <form class="contact__form" method="post" action="mail.php">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 contact-dvh form-group">
                    <textarea id="message" name="message" cols="30" rows="4" placeholder="Message *"
                      required=""></textarea>
                  </div>
                  <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
          ...
          <div class="footer-text">
            <p style="color:#fff;">
              Sign up below for updates about the world of Burberry, including collection launches and
              early access to limited-edition products and collaborations.</p>
